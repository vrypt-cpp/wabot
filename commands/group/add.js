import { guardAdmin, guardBotAdmin, getPhoneNumber } from './_helpers.js';
...
export default {
  ...
  async execute({ sock, msg, from, sender, args }) {
    ...
    if (!numbers.length) return sock.sendMessage(from, { text: '❌ Masukkan nomor yang ingin ditambahkan.\nContoh: /add 628xxxxxx' }, { quoted: msg });
